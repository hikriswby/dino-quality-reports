...
- 产物目录: `/Users/dino/dino-english-android/performance-toolkit/performance-results/run-all/20260815_115233`
...
| 主线程/jank 🟢 |  | trace-assert-runall_20260815_115441.md |

## 门禁

⏸️ 未判定：应用状态为 `welcome`，指标不具代表性，判红没有意义。

> ⚠️ **本次未采集到数据**：内存增长、泄漏引用链。
> 对应维度未产出新产物（步骤失败或设备异常），上表已不含这些指标——**不代表这些指标正常**，需查对应步骤日志。
...
- Flashlight: `/Users/dino/dino-english-android/performance-toolkit/performance-results/run-all/20260815_115233/flashlight.json`（`flashlight report` 可开网页）
