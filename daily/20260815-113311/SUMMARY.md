...
| 行为回归 [smoke] | ❌ FAIL | 737s | 3 条 flow 失败（脚本退出码为 0，见 REPORT.md） |
| 性能体检 | ✅ OK | 465s |  |
...
报告：`reports/e2e-run/20260815-114009/REPORT.md`
...
报告：`/Users/dino/dino-english-android/performance-toolkit/performance-results/run-all/20260815_115233/SUMMARY.md`

## 产物

- 本次跑批：`/Users/dino/dino-english-android/reports/quality-run/20260815-113311/`（run.log、build.log、e2e.log、perf.log）
