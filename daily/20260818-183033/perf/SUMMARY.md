...
- 产物目录: `/Users/dino/dino-english-android/performance-toolkit/performance-results/run-all/20260818_190058`
...
| 内存增长(单次遍历) | 12 MB (-1.85%) | maestro-performance-report.md |
| Java heap 直方图 | 🟢 无 Activity/Fragment 多实例 | heap-histogram.md |
| 泄漏(引用链) ⚠️ | 2 个: com.prime.dino.english.splash.SplashActivity | shark-leak-20260818_190447.txt |
| 主线程/jank 🟢 | jank 1.06%, 最长 42ms | trace-assert-runall_20260818_190452.md |

## 动态门禁阈值

| 指标 | 当前阈值 | 来源 | 样本 |
|---|---|---|---|
| jank_pct | > 20.0 | 基础阈值 | 3 |
| leak_count | > 3 | 基础阈值 | 3 |
| fl_fps | < 30.0 | 基础阈值 | 3 |
...
上次: `20260818_173143` (device `AKVR022B19000811` FRI-AN00)

| 指标 | 上次 | 本次 | 变化 |
|---|---|---|---|
| mem_growth_mb | 9.0 | 12 | 🔴 劣化 +3.0 |
| leak_count | 2.0 | 2 | ⚪ 持平 |
| jank_pct | 11.82 | 1.06 | 🟢 改善 -10.8 |
| worst_task_ms | 37.0 | 42 | 🔴 劣化 +5.0 |
...
- Flashlight: `/Users/dino/dino-english-android/performance-toolkit/performance-results/run-all/20260818_190058/flashlight.json`（`flashlight report` 可开网页）
